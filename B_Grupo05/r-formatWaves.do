...
add wave -noupdate -radix hexadecimal /projetofinal/RegDst
add wave -noupdate -radix hexadecimal /projetofinal/RegWrite
add wave -noupdate -radix hexadecimal /projetofinal/ALUResult
add wave -noupdate -radix hexadecimal /projetofinal/readData1
add wave -noupdate -radix hexadecimal /projetofinal/readData2
add wave -noupdate -radix hexadecimal /projetofinal/auxAluOp
